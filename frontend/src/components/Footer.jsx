...
const Footer = () => {
    return (
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-22 mt-12 '>
            ...
            className='group flex items-center gap-3 hover:scale-105 transition-transform duration-200 mb-4'>
                ...
                <span className="text-xs text-base-content/60 font-medium -mt-1">Code Together</span>
                    ...
                    <div className='flex items-center gap-3 mt-4'>
                        {/* Instagram */}
                        <svg className="w-6 h-6 hover:text-primary transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className='max-w-80'>
                    <p className='text-lg text-primary font-mono'>STAY UPDATED</p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">IntelliHire</a>. All rights reserved.</p>
