                            ...
                            <div className="space-y-6 mb-8">
                                {data.experience.map((exp, index) => (
                                    <div key={index}>
                                        ...
                                        {exp.description && (
                                            <ul className="list-disc list-inside text-sm text-zinc-700 leading-relaxed space-y-1 break-words">
                            ...
                            <div className="space-y-4">
                                {data.project.map((project, index) => (
                                    <div key={index}>
                                        ...
                                        {project.description && (
                                            <ul className="list-disc list-inside text-sm text-zinc-700 space-y-1 break-words">
