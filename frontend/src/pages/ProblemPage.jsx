...
function ProblemPage() {
  ...
  // this will run when the id or selectedLanguage changes
  useEffect(()=>{
    if(id && PROBLEMS[id]){
  ...
  const handleRunCode=async()=>{
    ...
    // check if code executed euccessfully and matched expected output
        ...
        <PanelGroup direction='horizontal'>
          ...
          <Panel defaultSize={60} minSize={30}>
            <PanelGroup direction='vertical'>
              ...
              <PanelResizeHandle className='h-2 bg-base-200 hover:bg-primary transtion-colors cursor-row-resize'/>
